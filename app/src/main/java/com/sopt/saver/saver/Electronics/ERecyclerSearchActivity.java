...
public class ERecyclerSearchActivity extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener {
...
//        Log.i("Tag", "메인");
    ...
    public void Networking() {
        Call<FindResult> getTotalFindResult = service.getTotalSearch(find_text);
        getTotalFindResult.enqueue(new Callback<FindResult>() {
            @Override

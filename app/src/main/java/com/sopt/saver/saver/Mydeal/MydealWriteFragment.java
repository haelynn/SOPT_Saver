...
public class MydealWriteFragment extends Fragment{
    ListView listView;
    MydealListAdapter mydealListAdapter;
    public MydealWriteFragment(){
    }
    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_mydeal_write, container, false);
        listView = (ListView)view.findViewById(R.id.frag_mydeal_write_lv);
